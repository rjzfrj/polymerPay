 ...
 * 据访问层基础支撑类.
 */
 /* 现在不用这个数源所以@Repository("basePolymerDao")*/
public class BasePolymerDaoImpl<T> extends SqlSessionDaoSupport implements BaseDao<T> {

	protected static final Log LOG = LogFactory.getLog(BasePolymerDaoImpl.class);
	 ...
	 */
	/*@Resource(name="sessionTemplate_polymer")*/
