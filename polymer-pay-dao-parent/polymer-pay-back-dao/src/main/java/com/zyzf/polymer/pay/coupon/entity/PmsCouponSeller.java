...
public class PmsCouponSeller {
    ...
    //定义行业类型一对一关联查询
    PmsIndustryType pmsIndustryType;

	public PmsIndustryType getPmsIndustryType() {
		return pmsIndustryType;
	}

	public void setPmsIndustryType(PmsIndustryType pmsIndustryType) {
		this.pmsIndustryType = pmsIndustryType;
	}
